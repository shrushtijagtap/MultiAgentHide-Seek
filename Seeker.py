        ...
        for h in hider_objs:
            for line in self.vision: 
                ...
                if start:
                    ...
                    self.game_no += 1
                    break
        reward = seek_rew # if seeker spots any seekers.
        reward += self.distance_reward(hider_cords)  # distance from hider, if more negative reward, if less, positive reward
